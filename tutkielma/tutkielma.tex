...
Tämä malli mahdollistaa nopean uusien lääkkeiden löytämisen, joita näin ollen päästään nopeasti jatkotutkimaan.
...
PlogP (Penalized logP) kuvaa aineen rasvaliukoisuutta, QED kuvaa, kuinka paljon tietty yhdiste on lääkkeenkaltainen ja DRD2 kuvaa, kuinka paljon molekyyli reagoi dopamiini 2 receptoria vastaan~\cite{BickertonGRichard2012Qtcb}.
...
Lääkeyhdisteiden löytäminen on kuitenkin ollut tavallisesti hidas prosessi ja uuden toimivan yhdisteen löytäminen on kestänyt useita vuosia~\cite{EkinsSean2019Emlf,}.
...
Virtuaaliseulonta (Virtual Screning, VS) on suosittu lähestymistapa uusien lääkkeiden löytämiseksi.
...
Virtuaaliseulonnan avulla löydettyjä yhdisteitä voidaan sitten jatkotutkia ja edelleen kehittää lääkkeiksi.
...
Se eroaa aikaisemmin kehitetyistä malleista siten, että se pystyy optimoimaan annetun molekyylin useampaa ominaisuutta samanaikaisesti.
...
Tanimoto -indeksi kertoo, kuinka paljon molekyylit muistuttavat toisiaan rakenteellisesti~\cite{MaggioraGerald2014Msim}.
...
Tämän todennäköisyysjakauman ja aikaisemman sanan avulla se laskee seuraavan sanan tulosteeseen.
