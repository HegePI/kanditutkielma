...
SMILES (Simplified Molecular Input Line Entry System) on David Weiningerin kehittämä tapa kuvata molekyylejä ja yksinkertaisia yhdisteitä~\cite{WeiningerSMILES}.
...
Lopulliset reaktiomäärät, joilla RPN ja EPN koulutettiin, olivat 17 134 ja 301 671.
Näillä säännöillä EPN ja RPN koulutetaan toimimaan hakualgoritmia ohjaavina neuroverkkoina.
