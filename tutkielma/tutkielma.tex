...
\examiners{Toht. Ruotsalainen, Laura}
...
Yritykset ovat alkaneet selvittää, kuinka eri koneoppimismalleja voidaan hyödyntää nopeuttamaan lääketutkimuksen suurimpia pullonkauloja~\cite{EkinsSean2019Emlf}.
...
Virtuaalinen seulonta (Virtual Screening, VS) on suosittu lähestymistapa uusien lääkkeiden tai lääkkeeksi kelpaavien yhdisteiden löytämiseksi.
...
CMG hyödyntää myös etukäteen koulutettuja rajoiteverkkoja (constraint network, CN), jolloin vältytään luomasta mahdottomia yhdisteitä.
...
ICHO -verkon (Instytut Chemii Organicznej) kouluttamisessa käytettiin dataa 1.4 miljoonasta reaktiosta ja niiden lopputuotteista.
...
% - data -> nopeakuvakulma minkälaista dataa käytetään, miten käytetään
% - ei käyty kaikkia mahdollisia datatyyppejä
% - miksi käytiin?

% - lääkkeiden löytäminen
% - Keskityttiin lääkkeiden löytämiseen tietokoneiden avulla, klassinen labralöytäminen jätettiin pois
% - miksi käytiin?

% - yhdisteiden syntetisoinnin sunnittelu ja sen taustaa
% - kaksi koneoppimismallia
% - miksi käytiin?
