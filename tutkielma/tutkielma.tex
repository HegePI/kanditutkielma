...
EPN ja RPN koulutettiin käyttämällä ADAM -optimoijaa.
...
EPN on toteutettu Highway -neuroverkkona (Highway network, HN), joka käyttää ELU -funktiota aktivointifunktiona.
% Koska EPN sisältää useita tasoja ja tasot sisältävät useita neuroneja, ~\cite{VeryDeepNetworks}.
